  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        ...
        XRDB_LOAD_COLOR("dwm.dmenunormfgcolor", dmenunormfgcolor);
        XRDB_LOAD_COLOR("dwm.dmenunormbgcolor", dmenunormbgcolor);
        XRDB_LOAD_COLOR("dwm.dmenuselfgcolor", dmenuselfgcolor);
        XRDB_LOAD_COLOR("dwm.dmenuselbgcolor", dmenuselbgcolor);
